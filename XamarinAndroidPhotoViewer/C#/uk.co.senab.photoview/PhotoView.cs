...
namespace Blurate
{
	public class PhotoView:ImageView,IPhotoView
	{
		...
		public PhotoView(Context context, IAttributeSet attr) :base(context, attr, 0){
			base.SetScaleType(ScaleType.Matrix);
			mAttacher = new PhotoViewAttacher(this);
		...
		public PhotoViewAttacher.IOnPhotoTapListener GetOnPhotoTapListener ()
		{
		...
		public PhotoViewAttacher.IOnViewTapListener GetOnViewTapListener ()
		{
